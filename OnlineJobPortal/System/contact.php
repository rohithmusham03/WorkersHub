...
<head>
	...
	<title>Workers Hub - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Nizampet, <br/> GRIET, <br/>Hyderabad</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:support@teamnerds.com">support@teamnerds.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+919985726345">+919985726345<a>
								</li>

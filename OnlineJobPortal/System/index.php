...
<head>
	...
	<title>Workers Hub - Job Portal</title>
...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<header id="header">
			...
			<nav class="navbar navbar-default navbar-fixed-top bg-dark navbar-sticky-function">

				<div class="container">
					
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/hi.png" alt="Logo" /></a>
						</div>
					</div>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.png');">
				<div class="container">
					...
					<h1>The Perfect Job Is Out Here!</h1>
					<p>Finding your next job or career on Workers Hub</p>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Workers hub</h5>
											<p>Workers hub is a job portal, online job management system developed by Team Nerds.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Workers Hub Contact</h5>
								
						
								<p>Email : <a href="support@teamnerds.com">support@teamnerds.com</a></p>
								<p>Phone : <a href="tel:+91 9063330544">9063330544</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Workers Hub Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Team Nerds</a></li>
								</ul>
